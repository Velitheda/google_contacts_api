  describe "Contact" do
    ...
    it "should return the right id" do
      expect(@contact.id).to eq(
        "http://www.google.com/m8/feeds/contacts/example%40gmail.com/base/0")
    end
    ...
    it "should return the right self link" do
      expect(@contact.self_link).to eq(
        "https://www.google.com/m8/feeds/contacts/example%40gmail.com/full/0")
    end
    it "should return the right photo link" do
      expect(@contact.photo_link).to eq(
        "https://www.google.com/m8/feeds/photos/media/example%40gmail.com/0")
    end
    it "should return the right edit link" do
      expect(@contact.edit_link).to eq(
        "https://www.google.com/m8/feeds/contacts/example%40gmail.com/full/0")
    end
    ...
    it "should return nil if there is no primary e-mail address" do
      ...
      @contact3 = GoogleContactsApi::Contact.new(
        contact_no_primary_email_json_hash)
    ...
    it "should return an empty array if no instant messaging accounts" do
      @contact = GoogleContactsApi::Contact.new(contact_no_emails_json_hash)
